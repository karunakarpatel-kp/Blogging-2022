...
// const genTextToSpeech = async (request: Request) => {
//   const requestBody = await request.json();
//   console.log(requestBody, "REQUEST_BODY");

//   // Check if there is no modelURL
//   if (!requestBody.modelURL) {
//     throw new Error("Missing 'model url' in the request body");
//   }
//   // Check if there is no input
//   if (!requestBody.input) {
//     throw new Error("Missing 'input' in the request body");
//   }

//   // check if hugging face acccess token
...
//   if (!response.ok) {
//     throw new Error("Request Failed With TextToSpeech Server");
//   }

//   const audioData: any = response.arrayBuffer();
...
// export default genTextToSpeech;
