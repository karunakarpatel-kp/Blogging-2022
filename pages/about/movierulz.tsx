...
const Movierulz: NextPageWithLayout = () => {
  ...
  return (
    <>
      <HeaderSection
        ...
        image={SEO_OBJ.MOVIERULZ_PAGE.featuredImage}
        url={SEO_OBJ.MOVIERULZ_PAGE.absoluteURL}
        publishedTime={SEO_OBJ.MOVIERULZ_PAGE.publishedTime}
        lastUpdatedTime={SEO_OBJ.MOVIERULZ_PAGE.lastUpdateTime}
      />
      ...
      <Grid container direction="row" sx={{ pl: { xs: 2, sm: 2, md: 0, lg: 0 }, pr: { xs: 2, sm: 2, md: 0, lg: 0 } }}>
        <Grid item md={10} lg={8}>
          <HeadingOne title={SEO_OBJ.MOVIERULZ_PAGE.title} id="title" />
          <Subtitle text={SEO_OBJ.MOVIERULZ_PAGE.description!} />
          <LastUpdateTags
            lastUpdatedTime={DateMonthYearForBlogPost(SEO_OBJ.MOVIERULZ_PAGE.lastUpdateTime)}
            tags={SEO_OBJ.MOVIERULZ_PAGE.tags!}
          />
          {/* Image For Desktop Screens */}
          <HeaderImageFullBlogPost
            image={SEO_OBJ.MOVIERULZ_PAGE.featuredImage}
            alt={SEO_OBJ.MOVIERULZ_PAGE.featuredImageAltText}
          />
        </Grid>
        <Grid item md={2} lg={4}>
          {/* Empty Space */}
      ...
      >
        <Grid item md={8} lg={8}>
          ...
          <Paragraph>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat eum quae perspiciatis mollitia temporibus
            voluptatum, optio harum ipsa impedit cum laborum obcaecati voluptas hic eius numquam natus deserunt dolorem
            ab.
          </Paragraph>
          <Paragraph>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. At, animi illo non illum aliquid aliquam vel ea
            atque tenetur suscipit velit maiores facere assumenda, beatae corporis et necessitatibus eaque eum? Ab hic
            provident ipsa. Repellat obcaecati ratione, tenetur vitae ullam praesentium incidunt repellendus magnam
            fuga, quam, velit iusto quia. In.
          </Paragraph>
        </Grid>
...
export default Movierulz;

Movierulz.getLayout = function getLayout(page: ReactJSXElement) {
