...
const TopWebsitesWithReactJs: NextPageWithLayout = () => {
...
export default TopWebsitesWithReactJs;

TopWebsitesWithReactJs.getLayout = function getLayout(page: ReactJSXElement) {
