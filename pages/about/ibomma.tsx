...
const Ibomma: NextPageWithLayout = () => {
  ...
  return (
    <>
      <HeaderSection
        ...
        image={SEO_OBJ.IBOMMA_PAGE.featuredImage}
        url={SEO_OBJ.IBOMMA_PAGE.absoluteURL}
        publishedTime={SEO_OBJ.IBOMMA_PAGE.publishedTime}
        lastUpdatedTime={SEO_OBJ.IBOMMA_PAGE.lastUpdateTime}
      />
      ...
      <Grid container direction="row" sx={{ pl: { xs: 2, sm: 2, md: 0, lg: 0 }, pr: { xs: 2, sm: 2, md: 0, lg: 0 } }}>
        <Grid item md={10} lg={8}>
          <HeadingOne title={SEO_OBJ.IBOMMA_PAGE.title} id="title" />
          <Subtitle text={SEO_OBJ.IBOMMA_PAGE.description!} />
          <LastUpdateTags
            lastUpdatedTime={DateMonthYearForBlogPost(SEO_OBJ.IBOMMA_PAGE.lastUpdateTime)}
            tags={SEO_OBJ.IBOMMA_PAGE.tags!}
          />
          {/* Image For Desktop Screens */}
          <HeaderImageFullBlogPost
            image={SEO_OBJ.IBOMMA_PAGE.featuredImage}
            alt={SEO_OBJ.IBOMMA_PAGE.featuredImageAltText}
          />
        </Grid>
        <Grid item md={2} lg={4}>
          {/* Empty Space */}
...
Ibomma.getLayout = function getLayout(page: ReactJSXElement) {
